...
const CheckoutPage = () => {
  ...
  const totalPrice = cartItems.reduce((acc, item) => item.newPrice + acc, 0).toFixed(2);
  ...
  const onSubmit = async (data) => {
    ...
    console.log("Form Data:", newOrder.productIds);
    // You can now use the `data` object, e.g., send it to an API
    ...
    try {
      ...
      Swal.fire({
        ...
        text: "Your order confirmed success",
        icon: "warning",
      ...
      console.log("error to place a order ",error);
      alert("error to place a order")
